...
export const nodeContracts: WorkflowNodeContract[] = [
  ...
  },
  {
    ...
    category: 'VLM',
    categoryColor: 'var(--accent-purple)',
    description: 'Medical VLM analysis using Gradio prompt presets',
  ...
  },
  {
    ...
    category: 'VLM',
    categoryColor: 'var(--accent-purple)',
    description: 'Fast lightweight VLM captioning for loaded slices',
    inputKinds: ['session', 'filePath', 'annotatedSession', 'voicePrompt'],
    outputKinds: ['vlmAnalysis'],
    defaultData: {
      label: 'SmolVLM',
  ...
  },
  {
    ...
    category: 'VLM',
    categoryColor: 'var(--accent-purple)',
    description: 'Reasoning-oriented medical VLM analysis',
    inputKinds: ['session', 'filePath', 'annotatedSession', 'voicePrompt'],
    outputKinds: ['vlmAnalysis'],
    defaultData: {
      label: 'Med-R1',
